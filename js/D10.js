...
var numeroRandom = Math.floor(Math.random() * 7) ;
return numeroRandom
}
...
console.log(onlyLetters("ho 4 cani e 1 gatto"));
...
console.log(isThisAnEmail("ciaogmail.com"));
/* ESERCIZIO 7
...
function isTodayMyBirthday() {
  let oggi = new Date();
  let comply = new Date(oggi.getFullYear(), 6, 7);

  return oggi.getDate() === comply.getDate() && oggi.getMonth() === comply.getMonth();
}
...
*/
function selezionaTuttiElementiTd() {
...
function TestoTd() {
  ...
  console.log(elementiTd[i].innerHTML);
  }
 }
...
let add = () => {
  ...
  let li = document.createElement('li.innertext');
  ul.appendChild(li)
}
